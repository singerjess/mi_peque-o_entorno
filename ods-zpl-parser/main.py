...
from mapper.classroom_assignment_problem_mapper import \
    ClassroomAssignmentProblemMapper
...
def main() -> int:
    ...
    semesters = []
    total_classrooms = [21, 22, 18, 26, 15, 20, 18, 23, 19, 22, 15, 20] # sacado del paper
